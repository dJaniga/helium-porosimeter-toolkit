"""
Factory reference-cell values and the default tolerances and uncertainties
...
# default the propagated pore-volume uncertainty is a few tenths of a percent.
# Increase it in the input file if readings drift (temperature instability,
# slow equilibration).
# ----------------------------------------------------------------------------
